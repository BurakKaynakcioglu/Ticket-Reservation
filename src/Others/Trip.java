...
public class Trip {
    ...
    static public List<String> SeferListesi = new ArrayList<>();
    ...
    static public final String[] sefer2 = {"Istanbul", "Kocaeli", "Bilecik", "Eskisehir", "Konya", "Eskisehir",
            "Bilecik", "Kocaeli", "Istanbul"};
    static public final String[] sefer3 = {"Istanbul", "Kocaeli", "Ankara", "Kocaeli", "Istanbul", "Kocaeli",
    ...
    public static void ekleArac (int kacinciSefer, String firma, String aracAdi, int koltukSayisi, String yakitTuru) {
        if (kacinciSefer == 3 || kacinciSefer == 4) {
            Bus yeniBus = new Bus(yakitTuru, koltukSayisi);

            if (kacinciSefer == 3) {
                Trip yeniTrip = new Trip(yeniBus, "09.12.2023", Trip.sefer3, firma, aracAdi);
                otobusListesi.add(yeniTrip);
            } else {
                Trip yeniTrip = new Trip(yeniBus, "09.12.2023", Trip.sefer4, firma, aracAdi);
                otobusListesi.add(yeniTrip);
            }
        }
            ...
            if (kacinciSefer == 1) {
                Trip yeniTrip = new Trip(yeniTrain, "09.12.2023", Trip.sefer1, firma, aracAdi);
                trenListesi.add(yeniTrip);
            } else {
                Trip yeniTrip = new Trip(yeniTrain, "09.12.2023", Trip.sefer2, firma, aracAdi);
                trenListesi.add(yeniTrip);
            }
        }
            ...
            if (kacinciSefer == 5) {
                Trip yeniTrip = new Trip(yeniAirplane, "09.12.2023", Trip.sefer5, firma, aracAdi);
                ucakListesi.add(yeniTrip);
            } else {
                Trip yeniTrip = new Trip(yeniAirplane, "09.12.2023", Trip.sefer6, firma, aracAdi);
                ucakListesi.add(yeniTrip);
            }
        }
    }
